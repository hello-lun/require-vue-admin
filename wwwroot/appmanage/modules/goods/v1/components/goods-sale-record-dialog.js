define([
    ...
    return {
        ...
        created: function () {
            // 初始化分页混合更新方法
            this.paginationUpdateFn = this.asyncGetGoodsSaleRecord;
        },
        ...
        methods: {
            asyncGetGoodsSaleRecord: function () {
                var self = this;
            ...
            handleSumColumn: function () {
                ...
                return [
                    ...
                    numeral(data.TotleMoney || 0).format('0,0.00'),
                    numeral(data.Discount || 0).format('0,0.00'),
                    numeral(data.PaidMoney || 0).format('0,0.00')
                ];
            }
        },
