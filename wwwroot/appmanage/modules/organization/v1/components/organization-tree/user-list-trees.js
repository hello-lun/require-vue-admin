    ...
    return {
        ...
        watch: {
            ...
            selectUser: {
                ...
                handler: function (newval, oldval) {
                    ...
                    //选中已有员工
                    if (self.selectUser != null && self.selectUser != undefined) {
                        this.$nextTick(function () {
                            var newKey = new Array();
                            var key = self.selectUser;
        ...
        methods: {
            ...
            asyncGetOrgData: function () {
                ...
                global.getParentAuthUser(function (user) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        url: "organization/api/User/GetAll",
                ...
                //$.get("/api/User/GetAll", function (data) {
                //    if (data != null && data != undefined) {
            ...
            filterNode(value, data) {
                ...
                return data.nameAccount.indexOf(value) !== -1;
            },
            //获取节点数组
            getCheckedNodes() {
